# AltLoad
# Import external BTC wallets to Alt Wallet
# Roni Bandini, Argentina, May-2022
# Bytearray conversion based on Jean-Yves VET code

# Dependencies
# sudo pip install picammera
# sudo pip install qrtools

# place into home/pi/btc folder
# Usage $ altLoader.py private (or altLoader.py public)
