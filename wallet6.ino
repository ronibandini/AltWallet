...
// plain text access pin (this cold wallet should be in a safe or whatever)
String comparePin="123456";
...
void authenticate(){
  ...
  for (int i = 0; i <= pinSize; i = i + 1) {    
    comparePin2=comparePin2+String(myPin[i]);
  }

  if (comparePin==comparePin2){
      ...
      lcd.clear(false);
      screenHeaders();
      lcd.println("Pin Correct"); 
      lcd.println("Opening pub"); 
      lcd.println("key...."); 
      delay(2000);
      lcd.clear(false);
  ...
  else
  {
      ...
      lcd.clear(false);
      screenHeaders();
      lcd.println("Wrong pin"); 
      lcd.println("Restart and"); 
